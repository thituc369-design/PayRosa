...
- [x] **PPT/Pitch deck link** — [View Pitch Deck](https://drive.google.com/file/d/1FjOdUVFBpNABr519fOyErdgVcHZHIh9e/view?usp=drive_link)
- [x] **Demo video link** — [Watch Demo](https://drive.google.com/file/d/1DR57dzCjvxCcAf_9jq9s2vdBirn59sDM/view?usp=drive_link)
...
- [x] **Google Sheet response export** — [open native Google Sheet](https://docs.google.com/spreadsheets/d/1gMEp08TgvXd2PF5dh9MTvYub3rsQhUQiJZNiHEdWtkk/edit?usp=drivesdk)

### Feedback survey

Have you tried PayRosa? [**Share your feedback**](https://docs.google.com/forms/d/e/1FAIpQLSd-SW8bYMAlkxMPBFpXXeqg0gHZ63NnhLLlpcK0o1619C4j1A/viewform) — a 2-minute public survey. Responses are collected in the feedback sheet linked above.
...
```
https://docs.google.com/spreadsheets/d/1gMEp08TgvXd2PF5dh9MTvYub3rsQhUQiJZNiHEdWtkk/edit?usp=drivesdk    # native Google Sheet response export
```
...
| Google Sheet response export | https://docs.google.com/spreadsheets/d/1gMEp08TgvXd2PF5dh9MTvYub3rsQhUQiJZNiHEdWtkk/edit?usp=drivesdk |
...
| [`docs/user-feedback-log.md`](docs/user-feedback-log.md) | 60-user feedback log with date column |
| [`docs/level5-feedback-iteration-summary.md`](docs/level5-feedback-iteration-summary.md) | Feedback-to-iteration map |
| Google Sheet response export | https://docs.google.com/spreadsheets/d/1s4ciGwuoo5bt7wvWOESERU9ChqtVOWJxuqjVJwhhiPU/edit?usp=drivesdk |
...
| Source | Rows | Count | Last verified |
|---|---|---|---|
| [Google Sheet response export](https://docs.google.com/spreadsheets/d/1s4ciGwuoo5bt7wvWOESERU9ChqtVOWJxuqjVJwhhiPU/edit?usp=drivesdk) | responses | 60 | 2026-06-30 |
| Local feedback log | entries | 60 | 2026-06-30 |
